...
.constant('StandardStates',[
    {name:'dp',data:{cancopy:true,toro:false,titles:{list:'Gestion des Offres de Prix',add:'une Offre de prix',edit:'l\'offre de prix',fields:['numero']}}},
